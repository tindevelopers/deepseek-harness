...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-skill-bootstrap -->
<a id="deepseek-aidsh-skill-bootstrap"></a>

## `@deepseek-ai/dsh-skill-bootstrap`

- `inject`: `skills`
- `source`: [`packages/skill/skill-bootstrap/src/index.ts:55`](../packages/skill/skill-bootstrap/src/index.ts)
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-skill-bootstrap -->
