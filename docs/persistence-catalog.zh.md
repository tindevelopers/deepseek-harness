...
| `id` | 必需 | `string` |
| `role` | 必需 | `"developer"` |
| `source` | 必需 | [`MessageSource`](#persistence-type-sha256-658cc8c967ee1e9504fca773f23e6c2e35ade2e4e78b45635165c467b01a291f) |

消息源兼容策略：`source` — `session-source-attribution` v1; `session.developer-message.source`; `kind`; `preserve`.

仅表示归属的新增 kind：`skill-bootstrap`, `tmux-context`.
...
[`Message`](#persistence-type-sha256-6fb3c8fb87ccfda063ec33c69159b46d364a3fcc9420fe65d2bb43588f817599) 的数组。
...
| `maxTokens` | 必需 | `number` |
| `messageSeqs` | 必需 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `messages` | 必需 | [`Message[]`](#persistence-type-sha256-45e1c23ad20ae4482c79dfb0c19c5c3bd100a3da61ff0a77daeb0f6426bd63b7) |
...
来源：[`packages/skill/skill-bootstrap/src/index.ts:35`](../packages/skill/skill-bootstrap/src/index.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `form` | 必需 | `"instructions"` |
| `kind` | 必需 | `"skill-bootstrap"` |
| `name` | 必需 | `string` |
...
[`UserMessage`](#persistence-type-sha256-a956c5b2be1afb502c7f8abc618ef6c9aa363da2a19dad41b93c86355ca3ac96) 的数组。
...
|---|---|---|
| `headerSeq` | 可选 | `number` |
| `message` | 必需 | [`DeveloperMessage`](#persistence-type-sha256-aa9c314695bf1e93f83585c41a009f46deecbd3bd6ea6ac9eaf8b1780116ed5e) |
| `step` | 必需 | `number` |
| `turn` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `inserted` | 必需 | [`UserMessage[]`](#persistence-type-sha256-054f6a4c5261005a6b5790fe1aa64c12997c0b51b2c095e7c7dc071cc86bbe03) |
| `outcome` | 可选 | `"canceled"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ inserted, outcome?, removedCount?, start, … }`](#persistence-type-sha256-505295be96d332bc3be6b40be22f379fb6dc87b3b4406891ad6277e11ef8b532) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ headerSeq?, message, step, turn }`](#persistence-type-sha256-e64e17ebe9aac9282f8a7846c197270214775fae95b31b0c9f5e569fa469fc12) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`SessionTitleLlmRequestEventData`](#persistence-type-sha256-2a54d012164cf509ab41c14d2420e828a7364c5ab78ad3b43a54286f4a7cc7d9) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`UserMessage`](#persistence-type-sha256-a956c5b2be1afb502c7f8abc618ef6c9aa363da2a19dad41b93c86355ca3ac96) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
