...
describe('unknown assertion source discovery', () => {
  ...
  it('includes untracked source while excluding ignored files, vendor, mirrored team skills, archives and other extensions', () => {
    const root = fixture()
    write(root, '.gitignore', 'ignored/\n')
    for (const file of ['ignored/input.ts', 'vendor/input.ts', '.dsh/skills/mirror/input.ts', '.agents/notes/archived/input.ts', 'docs/input.md']) {
